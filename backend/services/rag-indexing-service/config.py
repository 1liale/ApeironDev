...
class Settings(BaseSettings):
    """
    Service configuration settings for the RAG Indexing Service.
    Pydantic automatically reads from environment variables, which is ideal for
    a Cloud Function environment.
    """
