...
export const ShareWorkspaceDialog = ({
  ...
  const handleEmailInvite = async () => {
    ...
    try {
        ...
        await fetch(`/api/workspaces/${workspace.workspaceId}/share-email`, {
            method: "POST",
            headers: { "Content-Type": "application/json", "Authorization": `Bearer ${token}` },
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                ...
                <div className="text-sm text-muted-foreground">The project link is publicly viewable</div>
              </div>
              <Select value={linkRole} onValueChange={(value) => setLinkRole(value as "viewer" | "editor" | "owner")}>
                <SelectTrigger className="w-auto">
                  <SelectValue placeholder="Select a role..." >
                    <span className="capitalize">{`Can ${linkRole}`}</span>
                  </SelectValue>
                </SelectTrigger>
                <SelectContent>
